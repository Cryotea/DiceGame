    ...
    public void AttackPattern(IFighter attacker, IFighter defender)
    {
        ...
        switch (Turn % 2)
        {
            ...
            case 1:
                ...
                AnsiConsole.MarkupLine($"{attacker.Name} rolled a [red]{dice}[/] and attacked {defender.Name} for [red]{DamageDone} Damage[/]!  {defender.Name} got [springgreen2_1]Poisoned [/]for [springgreen2_1]{poisenDuration}[/] turns! and has[green] {defender.Health.Current} HP[/] left!");
                Turn++;
                break;
        }
    }
